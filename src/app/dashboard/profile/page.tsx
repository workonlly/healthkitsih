      ...
      <div className="w-full h-max flex flex-col gap-5 px-3 py-2">
        <div className="w-full h-max flex justify-between gap-3 ">
          ...
          <div className="w-max ">
            ...
            <h1 className="bg-[#262626] font-medium px-3 py-2 rounded-[15px]">6&#39; 1</h1>
          </div>
          <div className="w-max ">
        ...
        <div className="w-full h-max">
          <div className="w-max ">
            ...
            <h1 className="bg-[#262626] font-medium px-3 py-2 rounded-[15px] w-[400px] truncate">53/345 Kangra, Himachal Pradesh</h1>
          </div>
        </div>
        <div className="w-full h-max">
