  ...
  return (
    ...
    <div className="min-h-screen w-full flex justify-center items-center">
      <div className="w-1/2 text-white px-2 ">
        <h1 className="text-center text-3xl sm:text-4xl md:text-6xl font-bold leading-[115%] -tracking-[2%] text-balance scroll-m-20 mb-5">Simple Steps To Better Health</h1>
